...
const Chat: React.FC = () => {
  ...
  const initChatBot = async () => {
    ...
    const assistant = await openai.beta.assistants.create({
      name: "Medical Expert",
      instructions: "You are a Medical expert. You specialize in helping others in every health perspective.",
  ...
  const handleSendMessage = async () => {
    ...
    if (lastMessage) {
      ...
      setMessages([...messages, createNewMessage(lastMessage.content[0]["text"].value, true)]);
    }
  };
